...
- **Fase 16 (reportes y exportables) implementada 2026-08-07** — ver sección 4 "Reportes y exportables". Boleta de pago/vacaciones/liquidación (PDF/Excel) + exportación de planilla completa (Excel/CSV), todas con membrete de empresa. 105/105 tests backend en verde, typecheck/lint frontend en verde, verificado además con un caso real end-to-end en el navegador (Docker): contrato $2,500/mes + horas extra, boleta descargada con ISR $268.75 y el desglose cuadrando exacto al neto ($2,526.17 − $246.30 − $31.58 − $268.75 = $1,979.54). Sigue pendiente, no pedido en esta fase: reporte de auditoría descargable y un PDF consolidado multi-empleado más allá del Excel/CSV ya existente.
