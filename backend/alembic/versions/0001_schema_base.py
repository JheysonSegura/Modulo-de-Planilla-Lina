"""Esquema base de nómina (traducción literal de db/schema_nomina_panama.sql)

Revision ID: 0001_schema_base
Revises:
...
def downgrade() -> None:
    op.execute(
        ...
        DROP TABLE IF EXISTS provisiones_vacaciones;
        DROP TABLE IF EXISTS provisiones_decimo;
        DROP TABLE IF EXISTS conceptos_variables;
        DROP TABLE IF EXISTS movimientos_planilla;
        DROP TABLE IF EXISTS planillas;
        DROP TABLE IF EXISTS salario_minimo_vigente;
        DROP TABLE IF EXISTS tramos_isr;
        DROP TABLE IF EXISTS tasas_riesgo_profesional;
        DROP TABLE IF EXISTS tasas_vigentes;
