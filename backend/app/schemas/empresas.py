...
class EmpresaUpdate(BaseModel):
    ...
    empresa: son los campos que hacen falta para que
    salario_minimo_service pueda elegir la fila correcta de
    salario_minimo_vigente cuando hay más de una vigente."""
